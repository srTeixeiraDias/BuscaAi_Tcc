...
<div id="cadastro">
      ...
      <h1><font size="6" face="Malgun Gothic" id="titulocad"><center>Cadastro de produtos</center></font></h1><br>
        <font face="Malgun Gothic" size="4">Titulo do Produto:</font><input type="text" placeholder="" name="titulo" id="inputcadtitulo">
      ...
      <form method="POST" enctype="multipart/form-data" action="./configuracaoUsuario.php"> <br>
    <input type="file" name="pic" accept="image/*"> <br>
        <font face="Malgun Gothic" size="4">Descrição:</font> <br> <textarea rows="10" cols="40" maxlength="500" name="descricao"></textarea>
